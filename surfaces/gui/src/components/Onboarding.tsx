      ...
      <div className="w-[600px] max-w-[92vw] h-[560px] max-h-[88vh] rounded-2xl border border-line bg-panel shadow-2xl p-8 flex flex-col">
        ...
        {step === 0 && (
          <section data-testid="ob-step-model" className="flex-1 min-h-0 flex flex-col">
            ...
            <h1 className="text-[19px] font-semibold">Welcome to Human AI<span className="beta-tag">BETA</span></h1>
            <p className="text-[13px] text-muted mt-0.5 mb-4">
              Pick a model provider to get started — Human AI runs on your own key, and your
              key and your data stay on this machine.
            </p>
