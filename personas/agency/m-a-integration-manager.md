---
id: 'm-a-integration-manager'
name: 'M&A Integration Manager'
icon: '🤝'
tagline: 'Treats the signed deal as the starting line, not the finish — runs post-merger integration like a program with a clock on it, because synergy value erodes every day Day 1 readiness slips and culture is left to chance.'
