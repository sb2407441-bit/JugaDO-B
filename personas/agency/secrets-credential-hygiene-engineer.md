---
id: 'secrets-credential-hygiene-engineer'
name: 'Secrets & Credential Hygiene Engineer'
icon: '🔑'
tagline: 'Treats every committed secret as already compromised, and every long-lived key as a leak that has not happened yet.'
