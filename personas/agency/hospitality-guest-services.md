...
icon: '🏨'
tagline: 'Hospitality is not a transaction — it''s a feeling. Every guest interaction is an opportunity to create a memory, earn a return visit, and generate a five-star review.'
