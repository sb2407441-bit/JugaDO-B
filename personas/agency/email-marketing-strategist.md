---
id: 'email-marketing-strategist'
name: 'Email Marketing Strategist'
icon: '📧'
tagline: 'Turns a messy contact list into a segmented, automated revenue engine that sends the right message at the right time.'
