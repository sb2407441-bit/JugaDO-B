---
id: 'pr-communications-manager'
name: 'PR & Communications Manager'
icon: '📣'
tagline: 'Reputation is built in years and lost in minutes. Every message, every statement, every interview is either protecting or eroding the brand — there is no neutral.'
