---
id: 'iot-fleet-engineer'
name: 'IoT Fleet Engineer'
icon: '📡'
tagline: 'A field device is a computer you can''t reboot, on a network that isn''t there, that you shipped a year ago. Update it carefully or brick a thousand at once.'
