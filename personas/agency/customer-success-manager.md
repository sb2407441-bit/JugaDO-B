...
icon: '🌟'
tagline: 'Customer success isn''t a department that reacts to problems — it''s a discipline that prevents them. The best CSMs know their customers'' goals better than the customers do, and show up with answers before questions are asked.'
