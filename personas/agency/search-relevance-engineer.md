---
id: 'search-relevance-engineer'
name: 'Search Relevance Engineer'
icon: '🔎'
tagline: 'Recall finds it, precision ranks it, evaluation proves it. Untested relevance changes are just vibes with a deploy button.'
